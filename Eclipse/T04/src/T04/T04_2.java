...
public class T04_2 {
	    ...
	    public static void main(String[] args) {
	        ...
	        System.out.println("¿" + operador1 + " no es igual a " + operador2 + "? " + resultado3);
	        ...
	        System.out.println("¿" + operador1 + " es menor que " + operador2 + "? " + resultado6);
	        System.out.println("¿" + operador1 + " es menor o igual que " + operador3 + "? " + resultado7);
	        System.out.println("¿" + operador1 + " es mayor o igual que " + operador2 + "? " + resultado8);
